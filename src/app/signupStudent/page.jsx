...
export default function SignUpStudent() {
    const [student,setstudent] =useState({name:"",email:"",password:"",phonenumber:"",address:"",qualification:"",role:"student",region:"",dateofbirth:""})
    ...
    const handleSubmit = async(e) => {
        ...
        try {
          ...
          const res = await axios.post("/api/studentRegistration",student)
